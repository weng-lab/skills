---
name: unslop
description: Use before writing or revising prose for a person to read, including coworker messages, GitHub issues, pull request titles and descriptions, summaries, documentation, and planning documents.
---

# Unslop

Edit the requested text to remove AI patterns and add a natural voice.
